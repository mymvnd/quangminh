...
<?php
    ...
    && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['pass-confirm']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = register($id,$user,$pass,$first_name,$last_name,$email);
            if($result['code'] == 0){
                //success
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                ...
                <form method="post" action="" novalidate>
                    <div class="form-group">
                        ...
                        <input value="<?= $id?>" name="MSSV" required class="form-control" type="text" placeholder="enter MSSV" id="MSSV">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="firstname">First name</label>
                            <input value="<?= $first_name?>" name="firstname" required class="form-control" type="text" placeholder="First name" id="firstname">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="lastname">Last name</label>
                            <input value="<?= $last_name?>" name="lastname" required class="form-control" type="text" placeholder="Last name" id="lastname">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $user?>" name="username" required class="form-control" type="text" placeholder="Username" id="user">
                        <div class="invalid-feedback">Please enter your username</div>
                    </div>
                    <div class="form-group">
                        <label for="pass">Password</label>
                        <input  value="<?= $pass?>" name="password" required class="form-control" type="password" placeholder="Password" id="pass">
